    ...
    <main class="container mx-auto p-6 flex-1">
      ...
      >
        <button
          ...
          "
        >
          <img src="./assets/RockIcon.svg" alt="" class="w-full" />
        </button>
        <button
          @click="play('paper')"
          class="
          ...
          "
        >
          <img src="./assets/PaperIcon.svg" alt="" class="w-full" />
        </button>
        <button
          @click="play('scissors')"
          class="
          ...
          "
        >
          <img src="./assets/ScissorsIcon.svg" alt="" class="w-full" />
        </button>
      </div>
      ...
      <div v-else>
        ...
        </div>The computer picked <span class="text-green-500">{{computerChoice}}</span>
      </div>
